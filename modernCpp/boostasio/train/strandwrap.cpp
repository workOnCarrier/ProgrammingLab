...
int main(void) {
    ...
    io_svc->post(strandObj.wrap(boost::bind(&Print, 1)) );
    io_svc->post(strandObj.wrap(boost::bind(&Print, 2)) );
    io_svc->post(strandObj.wrap(boost::bind(&Print, 3)) );
    io_svc->post(strandObj.wrap(boost::bind(&Print, 4)) );
    io_svc->post(strandObj.wrap(boost::bind(&Print, 5)) );
